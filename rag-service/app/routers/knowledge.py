...
async def upload_document(
    brand_id: str, file: UploadFile = File(...), db: AsyncSession = Depends(get_db)
):
...
async def list_documents(brand_id: str, db: AsyncSession = Depends(get_db)):
...
@router.get(
    "/{brand_id}/knowledge/documents/{document_id}", response_model=DocumentResponse
)
async def get_document(
    brand_id: str, document_id: str, db: AsyncSession = Depends(get_db)
):
...
async def get_knowledge_stats(brand_id: str, db: AsyncSession = Depends(get_db)):
